  ...
  */
  head: {
    ...
    meta: [
      ...
      { hid: 'description', name: 'description', content: '水谷竜斗(MIZUTANI Ryuto) | 名古屋発世界に羽ばたくWebエンジニア。' },
      ...
      { hid: 'og:description', property: 'og:description', content: '水谷竜斗(MIZUTANI Ryuto) | 名古屋発世界に羽ばたくWebエンジニア。' },
